...
class _HomeLayoutState extends State<HomeLayout> {
        ...
        onPressed: () {
          if (isButtonSheetShown) {
            if(formKey.currentState!.validate()){
              InsertToDatabase(
                title:_titleController.text ,time: _timeController.text,date:_dateController.text ,
              ).then((value){
                              ...
                              children: [
                                ...
                                buildTextField(
                                    ...
                                    onTap: () {
                                      ...
                                      .then((date){_dateController.text=DateFormat.yMMMd().format(date!);});
                                    }),
                                buildTextField(
                                    widthRit:0.4,
                                    context: context,
                                ...
                                SizedBox(height: 0, width: MediaQuery.of(context).size.width * 0.4),
                                SizedBox(height: 0, width: MediaQuery.of(context).size.width * 0.4),
  ...
  required String date,
    ...
    await database.transaction((txn) async {
      ...
      await txn.rawInsert('INSERT INTO tasks VALUES("$currentIndex","$title","$date","$time","new")');
    }).then((_) {
